...
public class PubContent {
    ...
    static {
        ...
        addItem(new PubItem("1", "Phoenix","02476 520387", "122 Gosford Street, Coventry, CV1 5DL"));
        addItem(new PubItem("2", "Quid\'s Inn","024 7622 9551", "118 gosford street, Coventry, CV1 5DL"));
    ...
    public static class PubItem {
        ...
        public PubItem(String id, String name, String tel, String address) {
            this.id = id;
            this.name = name;
            this.tel = tel;
